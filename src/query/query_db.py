...
df = (
    ...
    .filter(pl.col("location") == "Amsterdam")#, pl.col("disease").is_in(["cholera", "smallpox"]))
...
plt = (
    ...
    + p9.facet_wrap("disease", scales="free")
    + p9.theme_linedraw()
    + p9.theme(axis_text_x=p9.element_text(rotation=90), legend_position="none")
    + p9.labs(
        title="Disease mentions in Amsterdam, 1830 - 1940",
...
p9.ggsave(plt, "img/amsterdam_all.png", width=15, height=9, dpi=300)