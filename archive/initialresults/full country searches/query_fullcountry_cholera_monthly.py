...
def query_for_municipality(disease: str, location_pattern: str, year: int = 1866, month: int = 12):
    df = pl.scan_parquet("processed_data/combined/combined_1866_1867.parquet")
...
results = []
print("Querying mentions for all municipalities in December 1866...")
...
output_csv_path = os.path.join(os.path.dirname(__file__), 'cholera_mentions_december_1866.csv')
