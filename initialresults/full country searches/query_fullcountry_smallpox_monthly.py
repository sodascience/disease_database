...
def query_for_municipality(disease: str, location_pattern: str, year: int = 1871, month: int = 12):
    n_total = 0
    n_both = 0
...
results = []
print("Querying mentions for all municipalities in a given month and year...")
...
output_csv_path = os.path.join(os.path.dirname(__file__), 'smallpox_mentions_december_1871.csv')
