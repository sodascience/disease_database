...
disease_query = r"pokken|variola"
location_query = r"franekeradeel|frjentsjerteradiel"
...
plt = (
    ...
    + p9.labs(
        title="Smallpox Mentions in Franekeradeel",
...
p9.ggsave(plt, "img/franekeradeel_smallpox.png", width=8, height=5, dpi=300)
