...
# Define the regular expression for disease (cholera specifically) and location (Amsterdam)
disease_query = r"cholera"
location_query = r"amster*"
...
# Querying only for cholera mentions in Amsterdam
...
# Plot for Amsterdam cholera mentions with key dates and smaller labels
plt = (
    p9.ggplot(
        qdf.with_columns(
    ...
    + p9.labs(
        title="Cholera mentions in Amsterdam",
...
p9.ggsave(plt, "img/amsterdam_cholera.png", width=8, height=5, dpi=300)
